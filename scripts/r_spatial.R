...
setwd("C:/Users/Ben/OneDrive/Documents/APCE QGIS")
...
dist2river_sa<-terra::rast("./_MyData/DistanceToRiver.tif")
...
r<-terra::rast("C:/Users/Ben/OneDrive/Documents/APCE QGIS/_MyData/landforms/CoreProtectedAreas.tif") 
